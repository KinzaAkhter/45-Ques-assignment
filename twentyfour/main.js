...
// Tests using "and" and "or" operators
// using && operator
console.log("twenty is not equal to ten and twenty is greater tha ten");
console.log(twenty != ten && twenty > ten);
console.log("twenty is not equal to ten and ten is greater tha twenty");
console.log(twenty != ten && ten > twenty);
// using || operator
console.log("twenty is greater than ten and twenty is not equal to twenty");
